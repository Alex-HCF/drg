...
public class TemplateEngine {
    ...
    private String generateXHtml(byte[] template, Map<String, ?> model) throws IOException, TemplateException {
        Template freemarkerTemplate = new Template("", new StringReader(new String(template, StandardCharsets.UTF_8)), FREEMARKER_CONFIG);
